...
const createTransporter = async () => {
  const oauth2Client = new OAuth2(
    ...
    "https://us-central1-kary-wagner-agent.cloudfunctions.net/oauth2callback"
  );
...
exports.gmailWebhook = functions.https.onRequest(async (req, res) => {
  ...
  try {
    ...
    console.log('Calling ChatGPT API with messages:', apiMessages);
  ...
  .onCreate(async (snapshot, context) => {
    ...
    await transporter.sendMail({
      ...
      text: `
        ...
        I hope this email finds you well. I'm ${agentConfig.agentName} from ${agentConfig.companyName}. 
